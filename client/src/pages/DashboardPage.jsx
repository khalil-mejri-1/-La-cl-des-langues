...
export default function DashboardPage() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 md:px-12 py-6 md:py-8 pb-24 md:pb-16 flex flex-col gap-6">
      {/* Welcome Header */}
      <header className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-5 bg-gradient-to-br from-[#e8f5e9] to-[#d5e5d6] rounded-3xl p-5 sm:p-6 border-2 border-[#8ee294]/60 shadow-md">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <section className="bg-white rounded-3xl p-5 sm:p-6 border-2 border-slate-200/80 shadow-md">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-2xl bg-[#e0d7ff] text-[#4221b6] flex items-center justify-center shrink-0">
        ...
        {/* Sidebar / Reminder Banner */}
        <aside className="flex flex-col gap-6">
          <div className="bg-gradient-to-br from-[#fff3e0] to-[#ffe0b2] rounded-3xl p-5 border-2 border-[#ffb74d]/60 shadow-md flex items-center gap-4">
