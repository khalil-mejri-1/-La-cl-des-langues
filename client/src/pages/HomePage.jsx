              ...
              <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-surface-variant/80 flex flex-col gap-5">
                ...
                <form onSubmit={handleAuthSubmit} className="space-y-4 text-left rtl:text-right">
                  ...
                  <button
                    type="button"
                    onClick={() => navigate('/parent')}
                    className="w-full h-12 rounded-full border border-surface-variant/70 bg-[#F4F1EA] hover:bg-surface-container-low text-on-surface font-bold text-xs flex items-center justify-center gap-2.5 cursor-pointer transition-colors"
                  >
