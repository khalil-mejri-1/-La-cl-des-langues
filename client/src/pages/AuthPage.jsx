        ...
        <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-surface">
          ...
          <form onSubmit={handleSubmit} class="space-y-5">
            ...
            <button
              ...
              class="w-full h-12 rounded-full border-2 border-surface-variant bg-surface-container-low hover:bg-surface-container text-on-surface font-label-bold flex items-center justify-center gap-3 cursor-pointer text-sm font-bold transition-colors"
            >
